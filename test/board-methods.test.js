...
describe("Board methods", () => {
	describe("b.boardHash()", () => {
		...
		test("default position", () => {
			...
			expect(board_obj.boardHash()).toBe(2042046915);
			...
			expect(board_obj.boardHash()).toBe(-119365364);
			expect(Ic.fenApply(shared_fen, "boardHash", [], {skipFenValidation : true})).toBe(-119365364);
		});
