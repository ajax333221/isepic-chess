...
<li><strong>:no_entry_sign: UI-less:</strong> All user interface code is completely separated into the <a href="https://github.com/ajax333221/isepic-chess-ui">Isepic Chess UI</a> project, keeping this library compact.</li>
