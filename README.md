...
------- | ---- | -----------
**BoardId** | Number | :wrench: ... **under construction** ... :wrench:<hr>Examples:<ul><li>`main_board.BoardId //0`</li><li>`other_board.BoardId //1`</li><li>`rff_board.BoardId //4`</li></ul>
**BoardName** | String | :wrench: ... **under construction** ... :wrench:<hr>Examples:<ul><li>`main_board.BoardName //"main"`</li><li>`other_board.BoardName //"other"`</li><li>`rff_board.BoardName //"resume_from_fen"`</li></ul>
